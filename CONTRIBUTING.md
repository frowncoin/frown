...
When you are starting to contribute to frown, we really would appreciate if you come by the gitter chat channels.

In case of problems with trying out frown, before starting to contribute, there's the [Support chat](https://gitter.im/frown_community/support). Write there about what you've done, what you want to do, and maybe paste logs through a text paste webservice.

* Please [join the frown Lobby](https://gitter.im/frown_community/Lobby) to get a feeling for the community.
* And [see the developers chat](https://gitter.im/frown_community/dev) if you have questions about source code files.
...
* Further information and discussions are in the [Forum](https://www.frown-forum.org/), the [website](https://frown-tech.org), the [mailing list](https://lists.launchpad.net/mimblewimble/) and news channels like the [@frowncouncil](https://twitter.com/frowncouncil) and a (mostly unfiltered!) Twitter bot that collects headlines, mailing list posts, and reddit posts related to MimbleWinble/Frown: [@frownmw](https://twitter.com/frownmw)
...
The most important thing you can do alongside - or even before - changing code, is adding tests for how frown should and should not work. See the various `tests` folders and derive test that are already there in frown.
...
For example: `fix: a panick on xxx when frown exiting`. Please don't worry if you can't find a suitable prefix, this's just optional, not mandatory.
...
**Note**: To work with frown you must use `rustup`. Linux package managers typically carry a too old rust version.
...
3. Please don't ~~`cargo +nightly fmt`~~ because all frown developers are using stable rustfmt. Also please don't rustfmt files that your code changes does not touch to avoid causing merge conflicts.

## Thanks for any contribution

Even one word correction are welcome! Our objective is to encourage you to get interested in Frown and contribute in any way possible. Thanks for any help!
