...
//! Modified from above to integrate into frown and allow for different
...
/// Frown uses blake2 everywhere but the spec calls for SHA512/Ripemd160, so allow
...
#[derive(Clone, Debug)]
pub struct BIP32FrownHasher {
	is_floo: bool,
	hmac_sha512: Hmac<Sha512>,
}

impl BIP32FrownHasher {
	/// New empty hasher
	pub fn new(is_floo: bool) -> BIP32FrownHasher {
		BIP32FrownHasher {
			is_floo: is_floo,
...
impl BIP32Hasher for BIP32FrownHasher {
	fn network_priv(&self) -> [u8; 4] {
		match self.is_floo {
...
impl ExtendedPrivKey {
	...
	pub fn from_mnemonic(
		...
		let mut hasher = BIP32FrownHasher::new(is_floo);
