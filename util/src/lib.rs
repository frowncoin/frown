...
//! patterns that are frequent within the frown codebase.
...
/// Global stopped/paused state shared across various subcomponents of Frown.
///
...
///
/// "Stopped" allows a clean shutdown of the Frown server.
