...
fn comments() -> HashMap<String, String> {
	...
	retval.insert(
		"[server]".to_string(),
		"
# Generated Server Configuration File for Frown
#
# When running the frown executable without specifying any command line
...
"
	...
	retval.insert(
		"db_root".to_string(),
		"
#the directory, relative to current, in which the frown blockchain
#is stored
"
		.to_string(),
	);
...
#real mining should use the standalone frown-miner
"
		.to_string(),
	);
...
"
	...
	retval.insert(
		...
		"
#host IP for wallet listener, change to \"0.0.0.0\" to receive frowns
"
		.to_string(),
	);
