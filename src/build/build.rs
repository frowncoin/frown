...
fn _download_and_decompress(target_file: &str) -> Result<bool, Box<std::error::Error>> {
	let req_path = format!("https://github.com/mimblewimble/frown-web-wallet/releases/download/{}/frown-web-wallet.tar.gz", _WEB_WALLET_TAG);
