...
use frown_wallet::{command, instantiate_wallet, NodeClient, WalletConfig, WalletInst, WalletSeed};
use frown_wallet::{Error, ErrorKind};
...
pub fn wallet_command(
	...
	let res = match wallet_args.subcommand() {
		...
		_ => {
			let msg = format!("Unknown wallet command, use 'frown help wallet' for details");
