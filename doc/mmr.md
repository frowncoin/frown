...
their 2 children. Frown uses the Blake2b hash function throughout, and always
...
In Frown, a lot of the data that gets hashed and stored in MMRs can eventually
