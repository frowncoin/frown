# Introduction to MimbleWimble and Frown
...
Frown is an open source software project that implements a MimbleWimble
blockchain and fills the gaps required for a full blockchain and
cryptocurrency deployment.

The main goal and characteristics of the Frown project are:
...
A detailed post on the step-by-step of how Frown transactions work (with graphics) can be found [in this Medium post](https://medium.com/@brandonarvanaghi/frown-transactions-explained-step-by-step-fdceb905a853). 
...
to explain the technical buildup of MimbleWimble and how it's applied in Frown. We hope
this document is understandable to most technically-minded readers. Our objective is
to encourage you to get interested in Frown and contribute in any way possible.

To achieve this objective, we will introduce the main concepts required for a good
understanding of Frown as a MimbleWimble implementation. We will start with a brief
description of some relevant properties of Elliptic Curve Cryptography (ECC) to lay the
foundation on which Frown is based and then describe all the key elements of a
...
Deterministic wallets heavily rely on this principle. MimbleWimble and the Frown
...
Frown, so if you're in a hurry, feel free to jump straight to
